...
<body>
            ...
            <table>
			    <tr>
				    ...
				    <td id="main_td">
				        <table id="table2">
				            <tr>
				                <td><a href="php/login.php" id="links">Play</a></td>
    				            <td><a href="php/login.php" id="links">Statistics</a></td>
    				            <td><a href="php/login.php" id="links">Winning numbers</a></td>
				                <td><a href="php/login.php" id="links">About</a></td>
				            </tr>
				        </table>
				    </td>
				    <td><b><u><a href="php/login.php" id="login">LOGIN</a></u></b></td>
			    </tr>  
		    </table>
	    </div>
    </header>
	...
	<div id="middle_footer">
        <div id="jackpot_text">
            ...
            <p>Your premier online platform for participating in one of <span class="highlight">Europe's biggest lotteries</span>! Here, you can <strong>purchase lottery tickets</strong>, select your numbers, and <strong>check results</strong> all in one convenient location. Every week, you have the chance to <span class="highlight">win massive prizes</span> and transform your life.<br>Come join our community and start your journey towards extraordinary winnings.<a href="php/login.php" id="links2"> Log in </a>now!</p>
            <br>
    ...
    <footer>
		<div id="bottom_footer">
            ...
            <a href="php/rules.php">Rules</a> | <a href="php/privacy.php">Privacy Policy</a> | <a href="php/terms_and_servis.php">Terms of Service</a>
